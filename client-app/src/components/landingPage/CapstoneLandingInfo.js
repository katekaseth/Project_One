...
function GoalStatement() {
    return (
        <div className='goal-statement'>
            <h2 className='encode-sans'>
                We are creating a consolidated data platform that enables UW academic and 
                administrative units to efficiently and easily navigate the University’s data 
                so they can achieve more with analytics.
            </h2>
        </div>
    )
}
